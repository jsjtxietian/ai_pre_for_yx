...
输入 有明确的边界：精准的上下文，避免 Agent 需要读大量内容
...
<div class="text-sm mt-1">记住，我们在和一个 <strong>概率系统</strong> 协作，但大脑其实习惯 <strong>确定性系统</strong> —— 这种错配会造成压力。</div>
</div>
